    ...
    <div className="min-h-screen flex items-center justify-center bg-k2-cream-dark px-4">
      <div className="max-w-md w-full bg-white rounded-card shadow-xl p-8 text-center">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-k2-green-deep mb-2">
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/"
            className="block w-full bg-k2-cream-dark hover:bg-gray-200 text-k2-ink font-semibold py-3 px-6 rounded-lg transition-colors"
          >
            Go Home
          </Link>
        </div>
