    ...
    <div className="space-y-6">
        ...
        {promotions.map((promo) => (
          <div
            ...
            className={`bg-white rounded-lg border-2 overflow-hidden shadow-lg ${
              promo.is_active ? 'border-orange-500' : 'border-gray-300 opacity-60'
            }`}
          >
            {promo.image_url && (
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                {promo.promo_code && (
                  <span className="text-xs text-gray-500">Code: {promo.promo_code}</span>
                )}
              </div>
      ...
      {promotions.length === 0 && !showForm && (
        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
          ...
          <p className="text-sm text-gray-500 mt-2">Click "Add Promotion" to create your first offer flyer</p>
        </div>
      )}
    </div>
  )
