    ...
    <section className="relative w-full min-h-[90vh] bg-gradient-to-br from-orange-50 via-white to-red-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[90vh] flex flex-col justify-center py-20">
        <div className="text-center space-y-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-100 to-red-100 border border-orange-200 rounded-full px-5 py-2 text-sm font-semibold text-orange-700 shadow-sm transform transition-all duration-300 hover:scale-105 hover:shadow-md animate-slide-down">
          ...
          <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-light px-4 animate-slide-up stagger-2">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center pt-4 sm:pt-6 px-4 animate-slide-up stagger-3">
            <Link href="/#products" className="group w-full sm:w-auto">
              <button className="group relative bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 overflow-hidden w-full sm:w-auto transform hover:scale-105 active:scale-95">
            ...
            <Link href="/recipes" className="group w-full sm:w-auto">
              <button className="bg-white border-2 border-gray-200 hover:border-orange-300 text-gray-700 hover:text-orange-600 px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl font-semibold text-base sm:text-lg shadow-sm hover:shadow-md transition-all duration-300 w-full sm:w-auto transform hover:scale-105 active:scale-95">
                View Recipes
              </button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-8 sm:pt-12 max-w-4xl mx-auto px-4">
            <div className="flex flex-col items-center gap-3 sm:gap-4 bg-white/80 backdrop-blur-sm border border-gray-100 rounded-2xl p-6 sm:p-8 hover:shadow-lg hover:border-orange-200 transition-all duration-300 group animate-slide-up stagger-4 transform hover:scale-105">
            ...
            <div className="flex flex-col items-center gap-3 sm:gap-4 bg-white/80 backdrop-blur-sm border border-gray-100 rounded-2xl p-6 sm:p-8 hover:shadow-lg hover:border-green-200 transition-all duration-300 group animate-slide-up stagger-5 transform hover:scale-105">
            ...
            <div className="flex flex-col items-center gap-3 sm:gap-4 bg-white/80 backdrop-blur-sm border border-gray-100 rounded-2xl p-6 sm:p-8 hover:shadow-lg hover:border-blue-200 transition-all duration-300 group animate-slide-up stagger-6 transform hover:scale-105">
