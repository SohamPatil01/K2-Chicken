      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-14 animate-slide-down">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto mb-5 sm:mb-6 px-4 animate-slide-up stagger-2 leading-relaxed">
            Learn to cook delicious Baramati agro chicken dishes at home with
            our expert recipes and cooking tips
          </p>
            ...
            >
              ...
              <div className="relative h-44 sm:h-48 overflow-hidden bg-gradient-to-br from-orange-50 to-red-50">
                <div className="w-full h-full flex items-center justify-center transform transition-all duration-700 ease-out group-hover:scale-110">
                  <div className="relative">
                    ...
                    <ChefHat
                      size={56}
                      className="text-orange-400 relative z-10 transform transition-all duration-500 group-hover:rotate-12 group-hover:scale-110"
                    />
                  </div>
                </div>
              ...
              <div className="p-5 sm:p-6">
                    ...
                    {recipe.ingredients.slice(0, 3).map((ingredient, idx) => {
                      ...
                      return (
                        <li key={idx} className="flex items-center gap-2">
                          ...
                          <span className="flex-1">{processedIngredient}</span>
                        </li>
                      );
                    })}
                ...
                >
                  <ChefHat
                    size={16}
                    className="transform transition-transform duration-300 group-hover/btn:rotate-12"
                  />
        ...
        <div className="text-center mt-10 sm:mt-12 animate-slide-up stagger-4">
          ...
          >
            ...
            <span className="transform transition-transform duration-300 group-hover:translate-x-1 text-lg">
              👨‍🍳
            </span>
          </Link>
        </div>
